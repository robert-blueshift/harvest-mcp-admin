...
const TOOLS = [
  ...
  { name: "harvest_admin_list_users", description: "List all users in the account. Can filter by active status. Shows name, email, roles, capacity, cost rates.", inputSchema: { type: "object", properties: { is_active: { type: "boolean" }, page: { type: "number" }, per_page: { type: "number", default: 100 } } } },
  ...
  { name: "harvest_admin_list_projects", description: "List all projects with client, budget, billing, and status info. Filterable by active status and client.", inputSchema: { type: "object", properties: { is_active: { type: "boolean" }, client_id: { type: "number" }, page: { type: "number" }, per_page: { type: "number", default: 100 } } } },
  ...
  { name: "harvest_admin_list_tasks", description: "List all tasks in the account. Tasks are shared across projects.", inputSchema: { type: "object", properties: { is_active: { type: "boolean" }, page: { type: "number" }, per_page: { type: "number" } } } },
  ...
  { name: "harvest_admin_list_clients", description: "List all clients.", inputSchema: { type: "object", properties: { is_active: { type: "boolean" }, page: { type: "number" }, per_page: { type: "number" } } } },
  ...
  { name: "harvest_admin_team_time_entries", description: "View time entries for any user or all users. Admins can see everyone's time. Filter by user, project, client, date range.", inputSchema: { type: "object", properties: { user_id: { type: "number" }, project_id: { type: "number" }, client_id: { type: "number" }, from: { type: "string" }, to: { type: "string" }, is_billed: { type: "boolean" }, page: { type: "number" }, per_page: { type: "number", default: 100 } } } },
...
async function handleTool(name, args) {
  switch (name) {
    ...
    case "harvest_admin_list_users": return await harvest.listUsers({ is_active: args.is_active, page: args.page, per_page: args.per_page });
    ...
    case "harvest_admin_list_projects": return await harvest.listProjects({ is_active: args.is_active, client_id: args.client_id, page: args.page, per_page: args.per_page });
    ...
    case "harvest_admin_list_tasks": return await harvest.listTasks({ is_active: args.is_active, page: args.page, per_page: args.per_page });
    ...
    case "harvest_admin_list_clients": return await harvest.listClients({ is_active: args.is_active, page: args.page, per_page: args.per_page });
    ...
    case "harvest_admin_team_time_entries": return await harvest.listTimeEntries({ user_id: args.user_id, project_id: args.project_id, client_id: args.client_id, from: args.from, to: args.to, is_billed: args.is_billed, page: args.page, per_page: args.per_page });
